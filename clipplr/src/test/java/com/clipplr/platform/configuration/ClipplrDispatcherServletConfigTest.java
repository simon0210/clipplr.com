...
@Configuration
public class ClipplrDispatcherServletConfigTest implements WebApplicationInitializer {
    private static final Logger logger = LoggerFactory.getLogger(ClipplrDispatcherServletConfigTest.class);
